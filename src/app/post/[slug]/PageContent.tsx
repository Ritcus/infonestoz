        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-start gap-4 md:gap-6">
              <Button variant="ghost"onClick={() => router.back()} asChild className="text-purple-900 hover:bg-purple-100">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight max-w-4xl">{post.title}</h1>
          ...
          <article className="prose lg:prose-xl max-w-none mb-12 bg-grey-800">
            ...
            <div className="flex justify-center gap-4 mt-10">
              ...
              <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t p-3 z-40 flex justify-between items-center">
                <ShareButtons title={post.title} slug={post.slug.current} variant="compact" />
