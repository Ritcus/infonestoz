          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-purple-100 mb-8">
                Delivering independent, thoughtful insights on the topics that
                matter most.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <p className="text-lg text-gray-700 mb-6">
                  Founded in 2024, InfoNest delivers thoughtful, unbiased
                  perspectives on technology, design, productivity, and
                  business.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  Free from corporate influence, we explore topics with depth
                  and nuance, always putting our readers&apos; interests first.
                </p>
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-purple-900 to-purple-800 text-white">
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg ">
                These core principles guide everything we do, from the topics we
                cover to how we interact with our community.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700">
                  We prioritize thoughtful, well-researched content over
                  clickbait. Every article is crafted to provide genuine value
                  to our readers.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700">
                  We maintain strict editorial independence. Our opinions are
                  our own, and we&apos;re transparent about our processes and
                  relationships.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700">
                  We strive to represent diverse viewpoints and experiences,
                  recognizing that the best insights come from a variety of
                  perspectives.
                </p>
              </div>
            </div>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-purple-900/70 to-transparent flex items-end">
                    <div className="p-6 text-white">
                      ...
                      <p className="text-sm text-purple-100">
                        We dive deep into topics that matter
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        We gather diverse perspectives and verify facts before
                        forming opinions.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Complex ideas deserve clear explanations. We make the
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        We foster conversations that matter and build a
                        community around shared curiosity.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-10 leading-relaxed">
                We believe that great content should inform, inspire, and
                empower. In a world of information overload, we strive to be a
                trusted voice that cuts through the noise with clarity and
                purpose.
              </p>
              <div className="flex flex-wrap justify-center gap-6 mt-12">
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl max-w-xs">
                  <p className="italic text-purple-100">
                    &quot;We don&apos;t chase trends—we explore ideas that stand
                    the test of time.&quot;
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl max-w-xs">
                  <p className="italic text-purple-100">
                    &quot;Our success is measured by the value we provide, not
                    the clicks we generate.&quot;
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl max-w-xs">
                  <p className="italic text-purple-100">
                    &quot;We believe in the power of words to change
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-700 mb-8">
                If you&apos;d like to be considered for our business directory
                or have your company featured for review, please feel free to
                contact us.
              </p>
              <Button
                asChild
