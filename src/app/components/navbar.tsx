                ...
                {link.label === "Posts" ? (
                  <div className="flex flex-col items-center" ref={dropdownRef}>
                    <button
                      ...
                      className={`text-lg font-medium px-6 py-3 rounded-lg w-64 text-center transition-all duration-300
                        ${
                          pathname.startsWith("/posts")
                    ...
                    >
                      {link.label}
                      <FaChevronDown
                        className={`inline-block ml-2 h-4 w-4 transition-transform ${isPostsDropdownOpen ? "transform rotate-180" : ""}`}
                      />
                    </button>
                    {isPostsDropdownOpen && (
                  ...
                  <Link
                    href={link.href}
                    onClick={() => setSideNavOpen(false)}
                    className={`text-lg font-medium px-6 whitespace-nowrap py-3 rounded-lg w-64 text-center transition-all duration-300
                      ${
                        pathname === link.href
                          ? link.isSpecial
                            ? "text-white bg-gradient-to-r from-amber-500 to-amber-600 shadow-lg"
