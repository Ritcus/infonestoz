...
console.log("Password length:", process.env.EMAIL_PASSWORD?.length);
    ...
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center">
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-8 rounded-lg mb-6">
          ...
          <h2 className="text-2xl font-bold mb-2">We&apos;ve Got Your Message!</h2>
  ...
  return (
    <div className="w-6xl px-4 py-12 bg-white text-gray-900 shadow-md rounded-xl self-center">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold mb-4">HAVE SOME QUESTIONS?</h1>
        <div className="h-1 w-24 bg-purple-600 mx-auto mb-6"></div>
        <p className="text-lg font-medium mb-2">MOLDOVA</p>
        <p className="text-gray-600">US : Standa 31 August 1989 78, Chainau, MD-2012</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-500">
              Messages will be sent to: <span className="font-medium">g0@gmail.com</span>
            </div>
            <button
              type="submit"
